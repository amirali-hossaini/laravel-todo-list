<aside class="bg-blue-600 w-full h-full sticky top-0">
    ...
    <nav>
        ...
        <a href="{{ route('tasks.index') }}"
            class="flex items-center text-white mb-2 justify-start gap-2 transition-all duration-300 mx-6 p-3 rounded-lg {{ request()->segment(1) === 'tasks' ? 'bg-blue-700' : 'bg-blue-500 hover:bg-blue-700' }}">
